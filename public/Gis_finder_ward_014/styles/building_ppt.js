...
window.getBuildingColor = function(gisId) {
    try {
        ...
        const surveyor_gisIds = JSON.parse(localStorage.getItem('surveyor_submitted_14_gisId') || '[]');
        const verify_gisIds = JSON.parse(localStorage.getItem('verify_reviewed_14_gisId') || '[]');
        const admin_gisIds = JSON.parse(localStorage.getItem('admin_reviewed_14_gisId') || '[]');
        const sadmin_gisIds = JSON.parse(localStorage.getItem('sadmin_reviewed_14_gisId') || '[]');
