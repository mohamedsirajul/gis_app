...
window.getBuildingColor = function(gisId) {
    try {
        ...
        const surveyor_gisIds = JSON.parse(localStorage.getItem('surveyor_submitted_41_gisId') || '[]');
        const verify_gisIds = JSON.parse(localStorage.getItem('verify_reviewed_41_gisId') || '[]');
        const admin_gisIds = JSON.parse(localStorage.getItem('admin_reviewed_41_gisId') || '[]');
        const sadmin_gisIds = JSON.parse(localStorage.getItem('sadmin_reviewed_41_gisId') || '[]');
