...
window.getBuildingColor = function(gisId) {
    try {
        ...
        const surveyor_gisIds = JSON.parse(localStorage.getItem('surveyor_submitted_35_gisId') || '[]');
        const verify_gisIds = JSON.parse(localStorage.getItem('verify_reviewed_35_gisId') || '[]');
        const admin_gisIds = JSON.parse(localStorage.getItem('admin_reviewed_35_gisId') || '[]');
        const sadmin_gisIds = JSON.parse(localStorage.getItem('sadmin_reviewed_35_gisId') || '[]');
        ...
        if (sadmin_gisIds.includes(gisId)) {
            return 'rgba(0, 100, 0, 0.8)';  // Dark g   reen for Super Admin reviewed
        }
