...
function EditVerificationProperties() {
  ...
  const fetchGisIds = async () => {
    try {
      ...
      if (data.success) {
        // Store surveyor submitted GIS IDs for all wards
        localStorage.setItem('surveyor_submitted_01_gisId', JSON.stringify(data.surveyor_submitted.ward01));
        localStorage.setItem('surveyor_submitted_14_gisId', JSON.stringify(data.surveyor_submitted.ward14));
        localStorage.setItem('surveyor_submitted_16_gisId', JSON.stringify(data.surveyor_submitted.ward16));
        localStorage.setItem('surveyor_submitted_35_gisId', JSON.stringify(data.surveyor_submitted.ward35));
        localStorage.setItem('surveyor_submitted_36_gisId', JSON.stringify(data.surveyor_submitted.ward36));
        localStorage.setItem('surveyor_submitted_41_gisId', JSON.stringify(data.surveyor_submitted.ward41));

        // Store verified GIS IDs for all wards
        localStorage.setItem('verify_reviewed_01_gisId', JSON.stringify(data.verified.ward01));
        localStorage.setItem('verify_reviewed_14_gisId', JSON.stringify(data.verified.ward14));
        localStorage.setItem('verify_reviewed_16_gisId', JSON.stringify(data.verified.ward16));
        localStorage.setItem('verify_reviewed_35_gisId', JSON.stringify(data.verified.ward35));
        localStorage.setItem('verify_reviewed_36_gisId', JSON.stringify(data.verified.ward36));
        localStorage.setItem('verify_reviewed_41_gisId', JSON.stringify(data.verified.ward41));

        // Store admin verified GIS IDs for all wards
        localStorage.setItem('admin_reviewed_01_gisId', JSON.stringify(data.admin_verified.ward01));
        localStorage.setItem('admin_reviewed_14_gisId', JSON.stringify(data.admin_verified.ward14));
        localStorage.setItem('admin_reviewed_16_gisId', JSON.stringify(data.admin_verified.ward16));
        localStorage.setItem('admin_reviewed_35_gisId', JSON.stringify(data.admin_verified.ward35));
        localStorage.setItem('admin_reviewed_36_gisId', JSON.stringify(data.admin_verified.ward36));
        localStorage.setItem('admin_reviewed_41_gisId', JSON.stringify(data.admin_verified.ward41));

        // Store super admin verified GIS IDs for all wards
        localStorage.setItem('sadmin_reviewed_01_gisId', JSON.stringify(data.sadmin_verified.ward01));
        localStorage.setItem('sadmin_reviewed_14_gisId', JSON.stringify(data.sadmin_verified.ward14));
        localStorage.setItem('sadmin_reviewed_16_gisId', JSON.stringify(data.sadmin_verified.ward16));
        localStorage.setItem('sadmin_reviewed_35_gisId', JSON.stringify(data.sadmin_verified.ward35));
        localStorage.setItem('sadmin_reviewed_36_gisId', JSON.stringify(data.sadmin_verified.ward36));
        localStorage.setItem('sadmin_reviewed_41_gisId', JSON.stringify(data.sadmin_verified.ward41));

        return {
          surveyorSubmitted: {
            ward01: data.surveyor_submitted.ward01,
            ward14: data.surveyor_submitted.ward14,
            ward16: data.surveyor_submitted.ward16,
            ward35: data.surveyor_submitted.ward35,
            ward36: data.surveyor_submitted.ward36,
            ward41: data.surveyor_submitted.ward41
          },
          verified: {
            ward01: data.verified.ward01,
            ward14: data.verified.ward14,
            ward16: data.verified.ward16,
            ward35: data.verified.ward35,
            ward36: data.verified.ward36,
            ward41: data.verified.ward41
          },
          adminVerified: {
            ward01: data.admin_verified.ward01,
            ward14: data.admin_verified.ward14,
            ward16: data.admin_verified.ward16,
            ward35: data.admin_verified.ward35,
            ward36: data.admin_verified.ward36,
            ward41: data.admin_verified.ward41
          },
          sadminVerified: {
            ward01: data.sadmin_verified.ward01,
            ward14: data.sadmin_verified.ward14,
            ward16: data.sadmin_verified.ward16,
            ward35: data.sadmin_verified.ward35,
            ward36: data.sadmin_verified.ward36,
            ward41: data.sadmin_verified.ward41
          }
        };
      } else {
